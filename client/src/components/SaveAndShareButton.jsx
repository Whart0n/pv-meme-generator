    ...
    <div className="flex flex-col items-end w-full gap-3">
      <div className="flex flex-col items-end gap-2 w-full">
        <input
          ...
          className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded text-sm w-64 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
          maxLength={32}
        />
        <button
          className="bg-green-600 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800 text-white px-4 py-2 rounded shadow font-semibold disabled:opacity-60"
      ...
      {error && <span className="text-red-500 dark:text-red-400 text-xs mt-2">{error}</span>}
    </div>
  );
}
